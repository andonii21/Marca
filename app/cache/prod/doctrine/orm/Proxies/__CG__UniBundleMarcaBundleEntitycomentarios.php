 ...
 */
class comentarios extends \Uni\Bundle\MarcaBundle\Entity\comentarios implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Uni\\Bundle\\MarcaBundle\\Entity\\comentarios' . "\0" . 'id', '' . "\0" . 'Uni\\Bundle\\MarcaBundle\\Entity\\comentarios' . "\0" . 'titulo', '' . "\0" . 'Uni\\Bundle\\MarcaBundle\\Entity\\comentarios' . "\0" . 'descripcion', '' . "\0" . 'Uni\\Bundle\\MarcaBundle\\Entity\\comentarios' . "\0" . 'fecha', '' . "\0" . 'Uni\\Bundle\\MarcaBundle\\Entity\\comentarios' . "\0" . 'nick', 'noticia');
        }
